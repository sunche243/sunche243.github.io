-- Tighten validation for new public registrations without rewriting legacy rows.
-- Existing tables, submissions, RLS policies, admins, and form fields are unchanged.
